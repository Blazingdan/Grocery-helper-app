...
if (showAuth) {
return ( <div className="p-6 max-w-md mx-auto"> <h1 className="text-4xl font-bold mb-2 text-center">Need help with groceries? Get a helper now.</h1>
...
return ( <div className="p-6 max-w-4xl mx-auto"> <h1 className="text-4xl font-bold mb-4">Get a helper now</h1> <p className="text-lg mb-6">Need help with your grocery trip? Book a helper nearby to shop with you or for you.</p>
